...
# when invoking this for org3 as redSEPR/scripts/org3-scripts
# the value is changed from default as $PWD (redSEPR)
...
infoln "Submitting transaction from a different peer (peer0.moe) which also signs it"
setGlobals 2
set -x
