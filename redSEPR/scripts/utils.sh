...
function printHelp() {
  ...
  if [ "$USAGE" == "prereq" ]; then
    ...
    println "    -ccep <policy>  - (Optional) Chaincode endorsement policy using signature policy syntax. The default policy requires an endorsement from CNE and MOE"
    ...
    println
    println " Examples:"
    println "   network.sh deployCC -ccn basic -ccp ../actas/chaincode-javascript/ ./ -ccl javascript"
    ...
    println
    println " Examples:"
    println "   network.sh deployCCAAS  -ccn basicj -ccp ../actas/chaincode-java"
    println "   network.sh deployCCAAS  -ccn basict -ccp ../actas/chaincode-typescript -ccaasdocker false" 
  elif [ "$USAGE" == "cc" ] ; then
    println "Usage: "
    ...
    println "   network.sh cc package -ccn basic -ccp chaincode/actas/go -ccv 1.0.0 -ccl go"
    ...
    println "      \033[0;32mdeployCC\033[0m - Deploy a chaincode to a channel (defaults to actas)"
